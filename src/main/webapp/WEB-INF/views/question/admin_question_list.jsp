...
<script>
	$(document).ready(function(){
		...
		jQuery("#ampaginationsm").on('am.pagination.change',function(e){
			$(location).attr('href','http://localhost:9000/banana/admin_question_list.do?rpage='+e.page);  
		});
...
<style>
	...
	section.section_notice_list>div>form.notice_list>h1{
		font-size:28px;
		margin-bottom:40px;
		margin-left:20px;
	}
	...
	section.section_notice_list>div>form.notice_list>table.notice_list tr td.write{
				...
				<form name="notice_listForm" action="notice_list_proc.do" method="get" class="notice_list">
					...
					<table class="notice_list">
			            ...
			            <tr>
			               	...
			               	<td class="left"><a href="admin_question_content.do?fid=${vo.fid }" class="list">${vo.ftitle }</a></td>
			            ...
			            <tr>
			            	<td colspan="4" class="write">
			            		<a href="admin_question_write.do"><button type="button" class="noticelist_btn_style">글쓰기</button></a>
			            	</td>
			            </tr>
			        </table>
				</form>
