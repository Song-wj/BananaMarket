...
<body>
	...
	<div class="notice_update">
		<section class="section_notice_content">
			<div>
				<form name="question_writeForm" action="admin_question_write_proc.do" method="post" class="admin_notice_update">
					<div>
					...
					<ul>
						...
						<li>
							...
							<textarea name="fcontent" rows="20" cols="100"></textarea>
						</li>
						<li class="wbutton">
							<button type="button" class="noticelist_btn_style" id="btnQuestionWrite">등록</button>
