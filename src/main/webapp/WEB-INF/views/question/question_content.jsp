			...
			<div>
				<form name="notice_contentForm" action="notice_content_proc.do" method="get" class="notice_content">
					...
					<table class="notice_content">
						...
						<tr>
							<td class="button">
								<a href="question_list.do"><button type="button" class="noticelist_btn_style">목록</button></a>
							</td>
						</tr>
						<tr>
							<td class="up">
								...
								<c:choose>
									...
									<c:otherwise>
										<a href="question_content.do?fid=${pre.fid }" class="list">${pre.ftitle }</a>
									</c:otherwise>
								</c:choose>
							</td>
						</tr>
						<tr>
							<td class="down">
								...
								<c:choose>
									...
									<c:otherwise>
										<a href="question_content.do?fid=${next.fid }" class="list">${next.ftitle }</a>
									</c:otherwise>
								</c:choose>
							</td>
						</tr>
