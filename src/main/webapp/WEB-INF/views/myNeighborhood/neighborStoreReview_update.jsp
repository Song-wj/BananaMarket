...
<body>
	...
	<div class="dongnelife_write">
		...
		<section class="section1_dongneLife_write">
			<div class="write_nav">
				<ul>
					<li><a href="neighborhoodStore.do"><img src="http://localhost:9000/banana/images/dongneLife_backword.png" class="backward"><button type="button"></button></a></li>
					<li><label>후기 수정하기</label></li>
		...
		<section class="section3_dongneLife_write">
			<div class="write_content">
				<textarea placeholder="여기에 후기를 남겨주세요." name="srcontent" id="srcontent">${vo.srcontent }</textarea>
			</div>
		</section>
		</form>
	</div>
