			...
			<div>
				<form name="notice_deleteForm" action="#" method="get" class="admin_notice_delete">
					<table class="admin_notice_delete">
						<tr>
							<td class="real"><h1>글을 삭제하겠습니까?</h1></td>
						</tr>
						<tr>
							<td class="trash">
						...
						<tr>
							<td class="button">
								...
								<a href="mypage_subjectContent.do"><button type="button" class="noticelist_btn_style">목록</button></a>
								<a href="mypage_subjectList_update.do"><button type="button" class="noticelist_btn_style2">이전페이지</button></a>
							</td>
						</tr>
					</table>
